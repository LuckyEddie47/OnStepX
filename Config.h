...
#define AXIS1_LIMIT_MIN              -220 //   -180, n. Where n= -90..-360 (degrees.) Minimum "Hour Angle" or Azimuth.        Adjust
#define AXIS1_LIMIT_MAX               220 //    180, n. Where n=  90.. 360 (degrees.) Maximum "Hour Angle" or Azimuth.        Adjust
...
#define MOUNT_LED_ON_STATE           HIGH //    Default is to switch Cathode, we need Anode
#define STATUS_LED_PIN                 18 //    Moved to  SCK
#define STATUS_BUZZER                 500 //    OFF, ON, n. Where n=100..6000 (Hz freq.) for speaker. ON for piezo buzzer.    Option
...
#define GUIDE_TIME_LIMIT               60 //     10, n. Time limit n=0..120 seconds. Use 0 to disable.                        Adjust
...
#define PARK_SIGNAL_PIN                15 //    Set to Z-min
#define PARK_STATUS                  HIGH //    OFF, signals with a HIGH or LOW state when successfully parked.               Option 
#define PARK_STATUS_PIN                 2 //    Set to Heater
...
#define PEC_SENSE_PIN                  23 //    Set to MOSI
...
// If runtime axis settings are enabled changes in the section below will be ignored (disable in SWS or by wiping NV/EEPROM):
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/
#define AXIS4_STEPS_PER_MICRON    4.21347 //    0.5, n. Steps per micrometer. Figure this out by testing or other means.      Adjust
...
#define AXIS4_LIMIT_MAX                44 //     50, n. Where n=0..500 (millimeters.) Maximum allowed position.               Adjust
...
// for TMC2130, TMC5160, TMC2209, TMC2226 STEP/DIR driver models:
#define AXIS4_DRIVER_IHOLD            400 //    OFF, n, (mA.) Current during standstill. OFF uses IRUN/2.0                    Option
#define AXIS4_DRIVER_IRUN             600 //    OFF, n, (mA.) Current during tracking, appropriate for stepper/driver/etc.    Option
#define AXIS4_DRIVER_IGOTO            600 //    OFF, n, (mA.) Current during slews. OFF uses IRUN.                            Option
// /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /
...
#define AXIS4_SENSE_LIMIT_MAX         OFF //    OFF, HIGH or LOW state on limit sense switch stops movement.                  Option
 ...
 #define FOCUSER_TEMPERATURE_PIN       36 //    Set to TE
// AXIS5 FOCUSER 2 -----------------------------------------------------------------------------------------------------------------
...
//#define FOCUSER_TEMPERATURE_PIN        39 // Set to TB
