...
// =================================================================================================================================
// CONTROLLER ======================================================================================================================
#define HOST_NAME "OnStepAux"      // OnStep", Hostname for this device up to 16 chars.                                 Adjust

#define DRIVER_TMC_STEPPER

// PINMAP ------------------------------------------------- see https://onstep.groups.io/g/main/wiki/Configuration_Controller#PINMAP
#define PINMAP OPB_ESP32  //    OFF, Choose from: MiniPCB, MiniPCB2, MaxPCB4, MaxESP4, MaxSTM3, FYSETC_E4,   <-Req'd \
...
// My Additions for WiFi
#define AP_SSID                    HOST_NAME
#define AP_PASSWORD              "onstepaux"
...
#define STA_IP_ADDR          {192,168,7,214}
...
#define FEATURE1_PURPOSE OFF //SWITCH     //    OFF, SWITCH, MOMENTARY_SWITCH, ANALOG_OUT, DEW_HEATER, INTERVALOMETER.        Option
#define FEATURE1_NAME "USB1-CAM"    // "FE..", Name of feature being controlled.                                        Adjust
#define FEATURE1_TEMP OFF           //    OFF, THERMISTOR or n. Where n is the ds18b20 s/n. For DEW_HEATER temperature. Adjust
#define FEATURE1_PIN OFF //33             //    OFF, AUX for auxiliary pin, n. Where n is the pin#.                           Adjust
...
#define FEATURE2_PURPOSE OFF //SWITCH     //    OFF, SWITCH, MOMENTARY_SWITCH, ANALOG_OUT, DEW_HEATER, INTERVALOMETER.        Option
#define FEATURE2_NAME "USB2-GUIDE"  // "FE..", Name of feature being controlled.                                        Adjust
#define FEATURE2_TEMP OFF           //    OFF, THERMISTOR or n. Where n is the ds18b20 s/n. For DEW_HEATER temperature. Adjust
#define FEATURE2_PIN OFF //32             //    OFF, AUX for auxiliary pin, n. Where n is the pin#.                           Adjust
...
#define FEATURE2_ON_STATE LOW       //   HIGH, LOW to invert so "ON" is 0V and "OFF" is Vcc (3.3V usually.)             Adjust

#define FEATURE3_PURPOSE OFF     //    OFF, SWITCH, MOMENTARY_SWITCH, ANALOG_OUT, DEW_HEATER, INTERVALOMETER.        Option
#define FEATURE3_NAME "USB3"        // "FE..", Name of feature being controlled.                                        Adjust
#define FEATURE3_TEMP OFF           //    OFF, THERMISTOR or n. Where n is the ds18b20 s/n. For DEW_HEATER temperature. Adjust
#define FEATURE3_PIN OFF //27             //    OFF, AUX for auxiliary pin, n. Where n is the pin#.                           Adjust
...
#define FEATURE3_ON_STATE LOW       //   HIGH, LOW to invert so "ON" is 0V and "OFF" is Vcc (3.3V usually.)             Adjust

#define FEATURE4_PURPOSE OFF     //    OFF, SWITCH, MOMENTARY_SWITCH, ANALOG_OUT, DEW_HEATER, INTERVALOMETER.        Option
#define FEATURE4_NAME "USB4"        // "FE..", Name of feature being controlled.                                        Adjust
#define FEATURE4_TEMP OFF           //    OFF, THERMISTOR or n. Where n is the ds18b20 s/n. For DEW_HEATER temperature. Adjust
#define FEATURE4_PIN OFF //26             //    OFF, AUX for auxiliary pin, n. Where n is the pin#.                           Adjust
...
#define FEATURE4_ON_STATE LOW       //   HIGH, LOW to invert so "ON" is 0V and "OFF" is Vcc (3.3V usually.)             Adjust

#define FEATURE5_PURPOSE  OFF //SWITCH     //    OFF, SWITCH, MOMENTARY_SWITCH, ANALOG_OUT, DEW_HEATER, INTERVALOMETER.        Option
#define FEATURE5_NAME "USB5 & 6"    // "FE..", Name of feature being controlled.                                        Adjust
#define FEATURE5_TEMP OFF           //    OFF, THERMISTOR or n. Where n is the ds18b20 s/n. For DEW_HEATER temperature. Adjust
#define FEATURE5_PIN OFF //25             //    OFF, AUX for auxiliary pin, n. Where n is the pin#.                           Adjust
...
#define FEATURE5_ON_STATE LOW       //   HIGH, LOW to invert so "ON" is 0V and "OFF" is Vcc (3.3V usually.)             Adjust

#define FEATURE6_PURPOSE SWITCH     //    OFF, SWITCH, MOMENTARY_SWITCH, ANALOG_OUT, DEW_HEATER, INTERVALOMETER.        Option
#define FEATURE6_NAME "CAMERA PSU"  // "FE..", Name of feature being controlled.                                        Adjust
