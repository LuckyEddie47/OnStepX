...
#define PLUGIN1              pecTimestamp //    OFF, Specify the class instance (same as plugin directory name) to enable.    Option
#include "pectimestamp/pectimestamp.h"    //         Specify the header file to include the class.
